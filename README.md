# Breu descripció:
## Hola, em dic Daniel, sóc un estudiant de 3r d'enginyeria informàtica a la Universitat Autònoma de Barcelona (UAB), aquí explicaré en detall els meus projectes universitaris més destacables:
...
Daniel Cruz Flores - 
Felipe Marcano Hurtado - 
Marc Solés i Rojas - 
Marco Mejías Alés - 
Samuel Jesus Outeda Aponte

# Proyecte Into The Wrath: Desenvolupament d'un videojoc en un motor gràfic a C amb modelatge 3D a Blender:
### detalls explicats en breus...
